      ...
      <div className="max-w-3xl mx-auto py-12 px-6">
        <div className="neu-flat p-10 mb-8">
          ...
          <p className="text-gray-500 dark:text-gray-400 text-lg">
            A neumorphic component library built with React and Tailwind CSS.
          </p>
        </div>
        <div className="neu-inset p-8 space-y-4">
          <p className="leading-relaxed dark:text-gray-300">
            Looply is a free, open-source collection of neumorphic UI components
            designed to help you build soft, tactile interfaces. Every component
            supports dark mode and is fully customizable.
          </p>
          <p className="leading-relaxed dark:text-gray-300">
            Built with Next.js, Tailwind CSS, and TypeScript. Package and use in
            your own projects via npm.
          </p>
        </div>
      </div>
    </>
